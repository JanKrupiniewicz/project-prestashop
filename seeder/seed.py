...
class Product:
    ...
    def to_xml(self) -> str:
        ...
        return template.render(name=self.name, price=self.price, category_id=self.category_id,
                               description=self.description, ean13=self.ean13)
...
class PrestashopSeeder:
            ...
            for category in dat.get("categories", []):
                ...
                for subcategory in category.get("subcategories", []):
                    ...
                    for product in subcategory.get("products", []):
                        ...
                        product_image_url = product.get("image_urls")
    ...
    def upload_product_image(self, product_id, image_paths):
